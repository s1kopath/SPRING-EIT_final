...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        ...
        <div class="card-header py-3">
            <a href="{{ url('tables/why-learn-course-content') }}" style="float: right;" class="ml-0 font-weight-bold text-primary ">Content List

            </a>
            <h6 class="mr-0 font-weight-bold text-primary t" style="float: left;">Edit Content</h6>
        </div>
            <div class="card-body">
            ...
            @endif
                <form class="forms-sample" method="post" action="{{route('why-learn-course-content.update')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    {{-- <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="educationDate" name="course_id" readonly>
                    ...
                    @foreach($whylearns as $whylearns)
                     ...
                     <div class="form-group row nopadding">
                        ...
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Add Course Content </label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="why_learn[]" value="{{ $whylearns->course_content }}" id="exampleInputUsername2" placeholder="Banner Name Highlite">
