        ...
        <form class="forms-sample" method="post" action="{{route('create.service')}}" enctype="multipart/form-data">
          ...
          <div class="form-group row">
           ...
           <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="service_topic" id="exampleInputUsername2" placeholder="Service Topic">
            </div>
          </div>
          <!--  <div class="form-group row">
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="py-1">
                  <img src="{{ asset('frontend') }}/images/service/{{$data->service_image}}" alt="image">
                </td>

                <td>
                 <a href="{{route('get.ServiceForm',['id'=>$data->id])}}"> {{ $data->service_name }}
                 </a>
                </td>
                <td>
                 {{ $data->service_topic }}
                ...
                <td>
                <a href="{{route('get.ServiceForm',['id'=>$data->id])}}">
                Edit
                </a>
                </td>
                 <td>
                <a href="{{route('service.remove',['id'=>$data->id])}}">
                delete
              <!--   </a> -->
                </td>
