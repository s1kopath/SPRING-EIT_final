    ...
    <div class="col-lg-12 grid-margin stretch-card">
       <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <h6 class="mr-0 font-weight-bold text-primary t" style="float: left;"><i class="fa fa-table" aria-hidden="true"></i>Product Feature</h6>
        </div>
            <div class="card-body">
                                    ...
                                    <div class="col-md-12 grid-margin stretch-card">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form class="forms-sample" method="post" action="{{route('product.feature')}}" enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                    ...
                                                    <div class="form-group row nopadding">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" class="form-control" name="product_features[]" id="exampleInputUsername2" placeholder="Product Feature">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                 ...
                                 <td>
                                    <a href="{{route('product.feature.edit',['id'=>$product_feature->id])}}">
                                        Edit
                                    </a>||
                                    <a href="{{route('product.feature.delete',['id'=>$product_feature->id])}}">
                                        Delete
                                    </a>
...
function education_fields() {
    ...
    divtest.innerHTML = '<div class="form-group row nopadding"><label for="exampleInputUsername2" class="col-sm-3 col-form-label">Product feature </label><div class="col-sm-7"><input type="text" class="form-control" name="product_features[]" id="exampleInputUsername2" placeholder="Product Feature"></div><div class="input-group-btn col-sm-2"><button class="btn btn-danger btn-sm" style="float:right;" type="button" onclick="remove_education_fields('+ room +');">remove</button></div></div><div class="clear"></div>';
