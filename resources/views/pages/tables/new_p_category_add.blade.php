    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header py-3">
                ...
                <h6 class="mr-0 font-weight-bold text-primary t" style="float: left;"><i class="fa fa-table" aria-hidden="true"></i> Category Table</h6>
            </div>
            <div class="card-body">
                ...
                <form class="forms-sample" method="post" action="{{route('category.add.new')}}">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="name" id="exampleInputUsername2" placeholder="Category Name">
                            @error('name')
