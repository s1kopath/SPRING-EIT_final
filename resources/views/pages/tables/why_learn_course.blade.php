    ...
    <div class="col-lg-12 grid-margin stretch-card">
       <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <h6 class="mr-0 font-weight-bold text-primary t" style="float: left;"><i class="fa fa-table" aria-hidden="true"></i> Why to Learn</h6>
        </div>
            <div class="card-body">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Why It Learn</h5>
                                    ...
                                    <div class="col-md-12 grid-margin stretch-card">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form class="forms-sample" method="post" action="{{route('why-learn-course')}}" enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                    ...
                                                    <div class="form-group row nopadding">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" class="form-control" name="why_learn[]" id="exampleInputUsername2" placeholder="Why To Learn">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                 ...
                                 <td>
                                    <a href="{{route('why-learn-course.edit',['id'=>$learns->id])}}">
                                        Edit
                                    </a>||
                                    <a href="{{route('why-learn-course.delete',['id'=>$learns->id])}}">
                                        Delete
                                    </a>
