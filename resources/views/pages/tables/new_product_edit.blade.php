    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header py-3">
                ...
                <h6 class="mr-0 font-weight-bold text-primary t" style="float: left;"><i class="fa fa-table" aria-hidden="true"></i> Product Update</h6>
            </div>
            <div class="card-body">
                ...
                <form class="forms-sample" method="post" action="{{route('product.update')}}"  enctype="multipart/form-data">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                        <input type="hidden" class="form-control" name="id" value="{{ $product->id }}" id="exampleInputUsername2" placeholder="Product Name">
                            <input type="text" class="form-control" name="product_name" value="{{ $product->product_name }}" id="exampleInputUsername2" placeholder="Product Name">
                            @error('product_name')
                     ...
                     <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                        <textarea class="form-control" name="short_description" value="" id="exampleFormControlTextarea1" rows="3">{{$product->short_description }}</textarea>
                     ...
                     <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="regular_price" value=" {{$product->regular_price }} " id="exampleInputUsername2" placeholder="0000.00">
                            @error('regular_price')
                            <div class="alert alert-danger">
                                <small>{{$message}}</small>
                            </div>
                      ...
                      <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="sale_price" id="exampleInputUsername2" value=" {{$product->sale_price }} " placeholder="0000.00">
                            @error('sale_price')
                            <div class="alert alert-danger">
                                <small>{{$message}}</small>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="educationDate" name="stock_status">
                                <option value="">-- Select Status --</option>
                                 <option value="1"{{($product->stock_status ==='instock') ? 'selected' : ''}}>Instock</option>
                                  <option value="1"{{($product->stock_status ==='outofstock') ? 'selected' : ''}}>Out of Stock</option>
                      ...
                      <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="quantity" value=" {{$product->quantity }} " id="exampleInputUsername2" placeholder="000">
                            @error('quantity')
                            <div class="alert alert-danger">
                                <small>{{$message}}</small>
                            </div>
                     ...
                     <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div id="id" style="">
                                <img id="output"  src="{{ asset('frontend') }}/admin_product/{{$product->image }}" height="120px" width="120px" style="margin-top: 10px; margin-left: 200px; " />
                            </div>
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="preview_link" id="exampleInputUsername2" value=" {{$product->preview_link }} " placeholder="Preview Link">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="educationDate" name="category_id">
                                ...
                                @foreach($p_c as $p_c)
                                 <option value="{{ $p_c->id }}"{{($product->category_id === $p_c->id) ? 'selected' : ''}}>{{ $p_c->name }}</option>
                                @endforeach
                            </select>
                            @error('category_id')
                            <div class="alert alert-danger">
