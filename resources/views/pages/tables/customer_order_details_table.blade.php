...
{{-- <div class="container-fluid"> --}}
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <h6 class="mr-0 font-weight-bold text-primary t" style="float: left;"><i class="fa fa-table" aria-hidden="true"></i>Order Details</h6>
        </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    @foreach($order_details as $key =>  $order_details)
                        ...
                        <td>{{ $order_details->product_price }}</td>
                         <td>{{ $order_details->product_quentity }}</td>
