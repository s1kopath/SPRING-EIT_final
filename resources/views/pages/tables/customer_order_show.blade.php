                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    @foreach($order as $key =>  $order)
                        ...
                        <td>{{$order->order_total  }}</td>
                         ...
                         <span class="badge badge-warning"> {{$order->shipping_status  }}</span>
                         @else
                          <span class="badge badge-success"> {{$order->shipping_status  }}</span>
                         ...
                         <td><a  href="{{ route('Order.Details.Show',['id'=>$order->oid]) }}">Details</a> || <a  href="{{ route('Shipping.Details.Show',['id'=>$order->shipping_id]) }}">Shipping</a> </td>
