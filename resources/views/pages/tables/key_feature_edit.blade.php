    ...
    <div class="col-lg-12 grid-margin stretch-card">
      <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="{{ route('key.view') }}" style="float: right;" class="ml-0 font-weight-bold text-primary ">Key feature List
            ...
            @endif
                <form class="forms-sample" method="post" action="{{route('key.feature.update')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    @foreach($features as $features)
                     ...
                     <div class="form-group row nopadding">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="key_features[]" value="{{ $features->key_features }}" id="exampleInputUsername2" placeholder="Banner Name Highlite">
